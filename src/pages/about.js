  ...
  `)
    return (
        <Layout>
            ...
            <h3>My resume</h3>
                <a href={myResumePdf.pdf.publicURL}><p>{myResumePdf.pdf.name} without download <FaFileDownload /></p></a>
                <a href={myResumePdf.pdf.publicURL} download><p>{myResumePdf.pdf.name} with download <FaCloudDownloadAlt /></p></a>
                </div>
        </Layout>
    )
}
